  ...
  const handleSubmitPress = () => {
    ...
    fetch(Config.API_URL + '/api/login', {
      ...
      .then((responseJson) => {
        ...
        if (responseJson.response_code == 200 && responseJson.message == "success") {
          AsyncStorage.setItem('token', responseJson.data.token);
          AsyncStorage.setItem('user_id', responseJson.data.user_id.toString());
          AsyncStorage.setItem('full_name', responseJson.data.full_name);
          AsyncStorage.setItem('employee_id', responseJson.data.employee_id.toString());
        ...
        <View>
          <KeyboardAvoidingView enabled>
            <View style={{alignItems: 'center'}}>
              <Image
                source={require('../Image/aboutreact3.png')}
                style={{
                  width: '50%',
                  height: 100,
                  resizeMode: 'contain',
